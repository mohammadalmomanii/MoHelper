 ...
 */
package com.devmo.mohelper.zoomImage;
...
public class ZoomImageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        zoomable = values.getBoolean(R.styleable.zoomImageView_zoomImage_zoomable, true);
        translatable = values.getBoolean(R.styleable.zoomImageView_zoomImage_translatable, true);
        animateOnReset = values.getBoolean(R.styleable.zoomImageView_zoomImage_animateOnReset, true);
        autoCenter = values.getBoolean(R.styleable.zoomImageView_zoomImage_autoCenter, true);
        restrictBounds = values.getBoolean(R.styleable.zoomImageView_zoomImage_restrictBounds, false);
        doubleTapToZoom = values.getBoolean(R.styleable.zoomImageView_zoomImage_doubleTapToZoom, true);
        ...
        doubleTapToZoomScaleFactor = values.getFloat(R.styleable.zoomImageView_zoomImage_doubleTapToZoomScaleFactor, 3);
        autoResetMode = AutoResetMode.Parser.fromInt(values.getInt(R.styleable.zoomImageView_zoomImage_autoResetMode, AutoResetMode.UNDER));
